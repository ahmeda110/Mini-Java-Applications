...
class Anthology extends Fiction {
  ...
  public void setStory(Story[] story) {
    if (story.length < 5) {
      System.out.println("Error: at least five stories have to be in an Anthology.");
    } else {
      this.story = story;
    }
  }
...
class Publisher {
  ...
  public void setClassicsCatalog(Classic[] classicsCatalog) {
    if (classicsCatalog.length < 0 || classicsCatalog.length > 10) {
      System.out.println("Error: there must be 0 to 10 Classics.");
    } else {
